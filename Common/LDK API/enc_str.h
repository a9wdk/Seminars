...
CstEncDataMrk vcode_mrk = {CstEncDataSig, vendor_code, sizeof(vendor_code)};	// Encrypt-маркер массива vendor_code

// 1-й параметр для функции hasp_get_info.
UCHAR scope[] = 
...
CstEncDataMrk scope_mrk = {CstEncDataSig, scope, sizeof(scope)};				// Encrypt-маркер массива scope

// 2-й параметр для функции hasp_get_info.
UCHAR format[] = 
...
CstEncDataMrk format_mrk = {CstEncDataSig, format, sizeof(format)};				// Encrypt-маркер массива format
