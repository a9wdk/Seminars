//*****************************************************************************
// (v01) Простейшая защита, удовлетворяющая минимальным требованиям:  
// если ключ есть - приложение запускается,
// если ключа нет - выводится сообщение об ошибке, приложение не запускается.
//
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	// Выполняем Login на Feature ID 0, если ошибка - выводим сообщение и завершаем работу.
